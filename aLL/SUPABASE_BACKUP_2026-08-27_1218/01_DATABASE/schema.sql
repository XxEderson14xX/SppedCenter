...
\restrict JcaKraW6c0EaZtJZ9mF36r6xxmAZqkQSeLXwprwz4erM7pyFTiDUJLGCNKFuHn0
...
begin
  ...
  if p_rol not in ('administrador','recepcion','consulta') then
  ...
  if exists (
    ...
    where lower(username) = lower(p_username) and id <> p_id
  ) then
...
CREATE TABLE "public"."perfiles" (
    ...
    "username" "text",
    "correo" "text",
    CONSTRAINT "perfiles_rol_check" CHECK (("rol" = ANY (ARRAY['administrador'::"text", 'recepcion'::"text", 'consulta'::"text"])))
);
...
\unrestrict JcaKraW6c0EaZtJZ9mF36r6xxmAZqkQSeLXwprwz4erM7pyFTiDUJLGCNKFuHn0
